...
echo "Veritabanı migrasyon işlemi başlatılıyor..."
echo "SQL Server'a bağlantı: SA@localhost:1433/MeetingAppDb"

# SQL komutlarını doğrudan çalıştır
docker exec meeting-app-backend-sqlserver-1 /opt/mssql-tools18/bin/sqlcmd -S localhost -U SA -P "YourStrong@Passw0rd" -Q "USE MeetingAppDb;
...
echo "Migrasyon işlemi tamamlandı!"
